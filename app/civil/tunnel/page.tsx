    ...
    <main className="bg-[#07111F] text-white overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(to right, rgba(7,17,31,0.95) 18%, rgba(7,17,31,0.78) 40%, rgba(7,17,31,0.20) 72%), url('/subsector-pages/tunnel-hero.png')",
          }}
        />
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-18 items-start">
          ...
          <div>
            ...
            <p className="text-gray-300 text-lg leading-9 mb-8">
              ...
              Tunnel construction projects require highly specialized professionals capable of managing technically advanced underground infrastructure, excavation systems, and challenging geotechnical conditions.

            </p>

            <p className="text-gray-300 text-lg leading-9">

              We help contractors and infrastructure developers secure experienced construction leaders and technical specialists for transportation tunnels, utility corridors, and underground civil developments.
