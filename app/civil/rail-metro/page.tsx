...
export default function RailMetroPage() {
  ...
  const roles = [
    "Project Managers",
    "Superintendents",
    "Transit Construction Managers",
    "Civil Project Engineers",
    "MEP Coordinators",
    "Estimators",
    "Schedulers",
    "Safety Managers",
    "Rail Infrastructure Specialists",
  ];
    ...
    <main className="bg-[#07111F] text-white overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(to right, rgba(7,17,31,0.95) 18%, rgba(7,17,31,0.78) 40%, rgba(7,17,31,0.20) 72%), url('/subsector-pages/railmetro-hero.png')",
          }}
        />
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-18 items-start">
          ...
          <div>
            ...
            <h2 className="text-4xl lg:text-5xl font-bold leading-tight mb-8">
              ...
              Modern Rail & Transit Projects

            </h2>

            <p className="text-gray-300 text-lg leading-9 mb-8">

              Rail and metro infrastructure projects require highly experienced professionals capable of managing technically advanced transportation systems and large-scale public infrastructure developments.

            </p>

            <p className="text-gray-300 text-lg leading-9">

              We help contractors and transit infrastructure firms secure project-ready construction leaders and technical specialists for rail corridors, metro systems, stations, and transportation expansions.
