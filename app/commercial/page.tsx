    ...
    <main className="bg-[#07111F] text-white overflow-hidden">
      ...
      <section className="relative h-screen w-full overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(to right, rgba(14,15,16,0.92) 16%, rgba(7,17,31,0.70) 38%, rgba(7,17,31,0.10) 70%), url('/subsector-pages/educational-hero.png')",
          }}
        />
      ...
      {/* ROLES */}
      <section className="py-28 px-8 bg-[#0B1422]">
