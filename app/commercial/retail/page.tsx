    ...
    <main className="bg-[#07111F] text-white overflow-hidden">
      ...
      <section className="relative min-h-[72vh] lg:min-h-[82vh] flex items-center overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(to right, rgba(7,17,31,0.96) 18%, rgba(7,17,31,0.78) 42%, rgba(7,17,31,0.22) 75%), url('/subsector-pages/retail-hero.png')",
          }}
        />
          ...
          <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-6 pt-28 sm:pt-30 lg:pt-20">
            ...
            <div className="max-w-[640px]">
              ...
              <p className="text-gray-300 text-[15px] sm:text-[17px] leading-7 sm:leading-8">
                ...
                RUDRON partners with contractors and developers to deliver experienced professionals specializing in retail developments, shopping centers, mixed-use spaces, and tenant improvement construction projects.
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div>
            ...
            <p className="text-gray-300 text-[15px] sm:text-[17px] leading-7 sm:leading-8 mb-6">
              ...
              Retail construction projects require experienced professionals capable of managing fast-track schedules, tenant coordination, phased construction operations, and customer-focused environments.

            </p>

            <p className="text-gray-300 text-[15px] sm:text-[17px] leading-7 sm:leading-8">

              We help contractors and developers secure project-ready leaders and technical specialists for shopping centers, retail campuses, mixed-use developments, and tenant improvement projects nationwide.
