    ...
    <main className="bg-[#07111F] text-white overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(to right, rgba(7,17,31,0.95) 18%, rgba(7,17,31,0.78) 40%, rgba(7,17,31,0.20) 72%), url('/subsector-pages/datacenter-hero.png')",
          }}
        />
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-18 items-start">
          ...
          <div>
            ...
            <h2 className="text-4xl lg:text-5xl font-bold leading-tight mb-8">
              ...
              High-Performance Data Facilities
