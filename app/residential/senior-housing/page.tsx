...
export default function SeniorHousingPage() {
  ...
  const roles = [
    "Project Managers",
    "Superintendents",
    "Senior Living Construction Managers",
    "Project Engineers",
    "MEP Coordinators",
    "Estimators",
    "Schedulers",
    "Safety Managers",
    "Healthcare Residential Specialists",
  ];
    ...
    <main className="bg-[#07111F] text-white overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(to right, rgba(7,17,31,0.95) 18%, rgba(7,17,31,0.78) 40%, rgba(7,17,31,0.20) 72%), url('/subsector-pages/seniorhousing-hero.png')",
          }}
        />
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-18 items-start">
          ...
          <div>
            ...
            <h2 className="text-4xl lg:text-5xl font-bold leading-tight mb-8">
              ...
              Modern Senior Living Developments

            </h2>

            <p className="text-gray-300 text-lg leading-9 mb-8">

              Senior housing construction projects require experienced professionals capable of managing healthcare-integrated residential developments, complex coordination systems, and high-quality living environments.

            </p>

            <p className="text-gray-300 text-lg leading-9">

              We help developers and contractors secure project-ready leaders and technical specialists for assisted living communities, independent living facilities, and senior residential developments nationwide.
