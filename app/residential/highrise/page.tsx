...
export default function HighrisePage() {
  ...
  const roles = [
    ...
    "Schedulers",
    "Safety Managers",
    "Tower Construction Specialists",
  ];
    ...
    <main className="bg-[#07111F] text-white overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(to right, rgba(7,17,31,0.95) 18%, rgba(7,17,31,0.78) 40%, rgba(7,17,31,0.20) 72%), url('/subsector-pages/highrise-hero.png')",
          }}
        />
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-18 items-start">
          ...
          <div>
            ...
            <h2 className="text-4xl lg:text-5xl font-bold leading-tight mb-8">
              ...
              Vertical Urban Developments

            </h2>

            <p className="text-gray-300 text-lg leading-9 mb-8">

              High-rise construction projects demand experienced professionals capable of managing technically advanced structures, dense urban logistics, and large coordination teams.

            </p>

            <p className="text-gray-300 text-lg leading-9">

              We help developers and contractors secure project-ready leaders and technical specialists for luxury towers, mixed-use communities, and large-scale vertical developments nationwide.
